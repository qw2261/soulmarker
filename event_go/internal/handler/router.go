...
func (h *Handler) apiRoutes() []apiRoute {
	...
	routes := []apiRoute{
		...
		{http.MethodGet, "/me/privacy/requests", "listMyPrivacyRequests", "", plain(h.ListMyPrivacyRequests)},
		{http.MethodPost, "/me/privacy/data-export", "exportMyData", "", plain(h.ExportMyData)},
		{http.MethodPost, "/me/privacy/account-erasure", "requestAccountErasure", "", plain(h.RequestAccountErasure)},
