...
const (
	...
	CodeOrganizationSlugInUse           ErrorCode = "ORGANIZATION_SLUG_IN_USE"
	CodeOrganizationInvitationExists    ErrorCode = "ORGANIZATION_INVITATION_EXISTS"
	CodeOrganizationInvitationInvalid   ErrorCode = "ORGANIZATION_INVITATION_INVALID"
	CodeOrganizationMemberNotFound      ErrorCode = "ORGANIZATION_MEMBER_NOT_FOUND"
...
var errorMessages = map[ErrorCode]string{
	...
	CodeOrganizationSlugInUse:           "该组织标识已被使用",
	CodeOrganizationInvitationExists:    "该邮箱已有待处理邀请",
	CodeOrganizationInvitationInvalid:   "组织邀请无效或已过期",
	CodeOrganizationMemberNotFound:      "组织成员不存在",
