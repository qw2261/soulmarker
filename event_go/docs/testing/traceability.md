...
| G5-R01 | v6.1 | Critical | Organization 作为授权/审计/未来计费租户，OrganizerProfile 保持公开资料和 `/organizers` 兼容；历史资料回填 unclaimed 且不猜 owner | Schema v12、Organization/OrganizerProfile、Store、ADR-004 | MIG-TENANT-V12-001、DOM-ORGANIZATION-001、COMPAT-ORGANIZER-V12-001 | G5.1 无新增公开旅程 | v6.1 test-report / Commit、Run Pending | Local Pass |
| G5-R02 foundation | v6.1 | Critical | active owner/admin 才能创建非 owner 邀请；每组织最多一个 active owner；接受者邮箱必须匹配登录邮箱或已验证恢复邮箱；过期与重复消费拒绝 | Schema v12、OrganizationMember/Invitation Store、ADR-004 | DOM-ORG-MEMBER-001、SEC-ORG-INVITE-001 | 自助邀请 API/UI 待 G5.4 | v6.1 test-report / Commit、Run Pending | Partial Local Pass |
| G5-R03 | v6.1 | High | owner/admin/editor/checker/finance 被数据库约束为唯一角色集合；owner 转移不得通过普通邀请完成 | Schema v12 checks、model role constants、active owner unique index | DOM-ORG-ROLE-001 | 权限矩阵待 G5.2 | v6.1 test-report / Commit、Run Pending | Local Pass |
