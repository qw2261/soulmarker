...
| G5-R03 | v6.1 | High | owner/admin/editor/checker/finance 被数据库约束为唯一角色集合；owner 转移不得通过普通邀请完成 | Schema v12 checks、model role constants、active owner unique index | DOM-ORG-ROLE-001 | 权限矩阵待 G5.2 | v6.1 test-report / Commit f548a29 / Run 29437366319 | Remote Pass |
