...
| G5-R04 foundation | v6.1 | Critical | platform_admin 与 organization_member principal/凭证互不替代；管理前端验证 principal_type；只读租户入口可独立关闭 | PlatformAdminAuth、organization context、admin.ts、ORGANIZATION_AUTH_ENABLED、ADR-005 | SEC-PRINCIPAL-SEPARATION-001、SEC-TENANT-FLAG-001、CT-API-TENANT-AUTH-001、FE-PLATFORM-PRINCIPAL-001 | 现有业务管理路由仍为 platform 双轨，待 G5.3 | v6.1 test-report / Commit 780c496 / Run 29440070376 | Partial Remote Pass |
